...
class Validation
{
    public static function get($_params = [], $_sanitize = true)
    {
        ...
        foreach ($_params as $param) {
            if (isset($_GET[$param])) {
                if ($_sanitize) {
                    $allowedParams[$param] = self::sanitizeValue($_GET[$param]);
                } else {
                    $allowedParams[$param] = $_GET[$param];
                }
            } else {
                return null;
            }
    ...
    public static function post($_params = [], $_sanitize = true)
    {
        ...
        foreach ($_params as $param) {
            if (isset($_POST[$param])) {
                if ($_sanitize) {
                    $allowedParams[$param] = self::sanitizeValue($_POST[$param]);
                } else {
                    $allowedParams[$param] = $_POST[$param];
                }
            } else {
                return null;
            }
    ...
    public static function header($_params = [], $_sanitize = true)
    {
        ...
        foreach ($_params as $param) {
            if (isset($headers[$param])) {
                if ($_sanitize) {
                    $allowedParams[$param] = self::sanitizeValue($headers[$param]);
                } else {
                    $allowedParams[$param] = $headers[$param];
                }
            } else {
                return null;
            }
    ...
    public static function checkFormatting(
        ...
        if ($_sanitize) {
            ...
            return (bool) preg_match($_regex, $_value);
        }
    }
    ...
    public static function isNumber($_value, $_options = [])
    {
        ...
        if (isset($_options['max']) && ($_value > (int) $_options['max'])) {
            return false;
        }
        if (isset($_options['min']) && ($_value < (int) $_options['min'])) {
            return false;
        }
    ...
    public static function sanitizeValue($_value, $_stripSlashes = false)
    {
        ...
        if ($_stripSlashes) {
            return stripcslashes($sanitizedValue);
        } else {
